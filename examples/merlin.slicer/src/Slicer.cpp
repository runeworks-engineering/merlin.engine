...
void Slicer::generateSample(Sample props){
    ...
    float yOverlapMin = props.y_offset - props.overlap / 2.0f;
    ...
    for (int layer = 0; layer < numLayers; ++layer) {
        ...
        add_gcode("G1 Z" + std::to_string(z) + " F17800");
        add_gcode("G1 E1.5 F2400");
        ...
        for (int i = 0; i < linesPerSection; ++i) {
            float y = (tool.id == 0 && layer % 2 == 0) ? yMin + i * props.line_width : yMax - i * props.line_width;
        ...
        for (int i = 0; i < linesPerSection; ++i) {
            float y = (tool.id == 0 && layer % 2 == 0) ? yMax - i * props.line_width : yMin + i * props.line_width;
            if (i > linesPerSection - overlapLines) flow *= props.overlap_flow_modifier;
            if (layer == 0) flow *= 1.2f;
